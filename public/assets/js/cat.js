(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["assets/js/cat"],{
...
/* harmony import */ var _components_Media4__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/Media4 */ "./resources/js/components/Media4.vue");
/* harmony import */ var vue_pagination_2__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vue-pagination-2 */ "./node_modules/vue-pagination-2/compiled/Pagination.js");
/* harmony import */ var vue_pagination_2__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(vue_pagination_2__WEBPACK_IMPORTED_MODULE_3__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    Media4: _components_Media4__WEBPACK_IMPORTED_MODULE_2__["default"],
    Pagination: vue_pagination_2__WEBPACK_IMPORTED_MODULE_3___default.a
  },
  watch: {
  ...
  methods: {
    getData: function getData() {
      ...
      window.axios.post(_api__WEBPACK_IMPORTED_MODULE_1__["api"].news, parameter).then(function (res) {
        _this.loading = false;
        _this.error = false;
        var r = res.data;
        var app = _this;
                ...
                _c("div", { staticClass: "row" }, [
                  _c(
                    ...
                    [
                      _vm.data.length <= 0
                        ? _c("div", { staticClass: "text-center" }, [
                            _c("h2", [_vm._v("Data not available")])
                          ])
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.filter.page == 1 && _vm.main_news
                        ? _c("Media4", { attrs: { data: _vm.main_news } })
                        : _vm._e()
                    ],
                    1
                  )
